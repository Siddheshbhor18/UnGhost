...
export function SpeakerSpotlight() {
  ...
  return (
    <div
      className="relative isolate overflow-hidden rounded-3xl px-6 py-12 shadow-[0_24px_80px_-32px_rgba(1,86,158,0.22)] ring-1 ring-brand-500/10 sm:px-10 md:py-16 lg:px-16"
      style={{
        background:
          "linear-gradient(155deg, #EAF4FE 0%, #F7FBFF 58%, #FFFFFF 100%)",
      }}
    >
      {/* Soft brand light wells — subtle depth on the light panel */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10"
        style={{
          background: `radial-gradient(70% 120% at 50% -8%, ${BLUE}14, transparent 60%),
                       radial-gradient(60% 90% at 100% 100%, ${BLUE}0F, transparent 65%)`,
        }}
      />

      <div className="relative mx-auto max-w-3xl text-center">
        <span
          className="inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-600"
          style={{ background: `${BLUE}14`, border: `1px solid ${BLUE}33` }}
        >
          Guest sessions
        </span>

        <h2
          className="mt-6 font-display text-4xl font-extrabold leading-[1.04] tracking-tight text-neutral-950 text-balance sm:text-5xl lg:text-6xl"
        ...
        <p className="mx-auto mt-5 max-w-2xl text-body-md leading-relaxed text-neutral-700 md:text-body-lg">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-brand-500 px-7 py-3.5 text-base font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_10px_30px_-8px_rgba(1,145,252,0.45)] transition-all duration-200 hover:bg-brand-600 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_14px_36px_-10px_rgba(1,145,252,0.6)] active:scale-[0.98]"
          >
            Enroll now
          </Link>
        </div>
      ...
      >
        <div className="relative overflow-hidden rounded-2xl ring-1 ring-neutral-950/10 shadow-[0_40px_100px_-40px_rgba(1,86,158,0.35)]">
          <video
            ref={videoRef}
        ...
        <figcaption className="mt-5 flex flex-col items-center gap-2 text-center">
          <p className="text-body-md text-neutral-600">
            Session with{" "}
            <span className="font-semibold text-brand-600">Abhinav Ranka</span>
          </p>
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-neutral-700">
