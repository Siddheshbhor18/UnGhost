...
/**
 * Scroll-velocity marquee (vendored). Adapted for this codebase:
 * - `motion/react` → `framer-motion` (same engine; the repo already ships
 *   framer-motion 11 and installing `motion` would duplicate it).
 * - `@/lib/utils` → `@/shared/lib/cn` (the house cn helper).
