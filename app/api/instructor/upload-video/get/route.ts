...
/**
 * GET /api/instructor/upload-video/get?key=…
 *
 * Mock-mode only. Streams back a previously uploaded video by key so
 * <video src> can play it during dev. Production serves these files
 * directly from R2's public base URL.
 */
